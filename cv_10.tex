...
\header{cory}{schillaci}{Machine Learning Engineer} % Your name and current job title/field
...
%\smallskip
%\entry{Aug. 2009 - \\Dec. 2015}
%{Graduate Studies in Physics}
%{University of California, Berkeley}
%{\vspace{-\baselineskip}
%\begin{itemize}
%\item Developed numerical techniques and related software to study the spectra of quantum systems with exotic interactions
%\item Completed graduate level courses in machine learning and statistical inference within the computer science department.
%\item Collaboration with Berkeley Institute of Data Science and Prof. John Canny to study LiveJournal corpus (300GB), resulting in a publication describing a novel tool for qualitative data exploration based on word embeddings. Preprocessing pipeline was developed in Scala and BIDMat/BIDMach packages were used for machine learning at scale.
%%\item Support custom data mining needs of business team
%\end{itemize}
%}
\end{entrylist}
